...
LOCALES : Locales =\
{
	'en':
	{
		...
		'stream_closed': 'stream {stream_mode} was closed unexpectedly (exit code {return_code})',
		'stream_frame_not_written': 'stream frame could not be written: {error}',
		'virtual_camera_opened': 'virtual camera {device_path} ({device_label}) opened at {resolution} {pixel_format}',
		'virtual_camera_not_opened': 'virtual camera {device_path} could not be opened: {error}',
		'virtual_camera_format_not_supported': 'virtual camera {device_path} reports an unsupported format {device_format}',
		'virtual_camera_format_locked': 'virtual camera {device_path} is held at {device_resolution} by another application, output scaled from {resolution}; set the OBS source to {resolution} or re-add it',
		'virtual_camera_not_found': 'virtual camera not found, no v4l2loopback device labeled FaceFusion exists so nothing was streamed',
		'virtual_camera_format_changed': 'virtual camera resolution changed from {previous_resolution} to {resolution}, reselect the device in OBS',
		'virtual_camera_busy': 'virtual camera {device_path} is already being written by another application, close it and press start again',
		'virtual_camera_frame_not_written': 'virtual camera frame could not be written: {error}',
		'stream_not_supported': 'stream not supported',
		'stream_frame_not_processed': 'stream frame could not be processed: {error}',
		'stream_frame_not_analysed': 'stream frame could not be analysed: {error}',
		'stream_frame_not_captured': 'stream frame could not be captured: {error}',
		'stream_stopped_by_analyser': 'stream stopped by the content analyser',
		'stream_stopped_by_camera': 'stream stopped by the camera',
